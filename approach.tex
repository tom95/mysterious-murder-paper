...
\todo{either: All rules require certain preconditions, such as characters being alive or dead, or not currently being married when proposing to another character.}
...
We pass the simulation to a MCTS agent, which then expands child states via upper confidence bounds (UCB1) \todo{tom: ref UCB1 and is it actually called that?}.
