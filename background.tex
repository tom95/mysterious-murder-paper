...
The application of linear logic has been studied in the context of games and programming languages, as well as in quantum physics and linguistics \cite{sep-logic-linear}. \todo{william: is this relevant? if so cite}
